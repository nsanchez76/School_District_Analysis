...
The District Summary does not appear to be extremely affected by the removal of the Thomas High School Ninth Grade reading and math scores. The change is at most .2% as shown below:
...
Replacing the Thomas High School ninth grade math and reading scores affects math and reading scores by grade in the following ways:
...
Replacing the Thomas High School ninth grade math and reading scores affects "Scores by School Spending" in the following ways:
...
Replacing the Thomas High School ninth grade math and reading scores affects "Scores by School Size" in the following ways:
...
Replacing the Thomas High School ninth grade math and reading scores affects "Scores by School Type" in the following ways:
